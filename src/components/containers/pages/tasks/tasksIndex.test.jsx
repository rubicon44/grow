...
describe('タスク一覧', () => {
  ...
  it('should login and navigate to "/tasks" page', async () => {
    ...
    const value1 = await page.$eval('input[name="email"]', (input) => input.value);
    console.log(value1);
    ...
    const value3 = await page.$eval('input[name="email"]', (input) => input.value);
    console.log(value3);

    const value4 = await page.$eval('input[name="password"]', (input) => input.value);
    console.log(value4);
